...
namespace UnityEngine.EventSystems
{
	public class MyInputModule : PointerInputModule
	{
		...
		void Update()
		{
			...
			{
				SendMoveEventToSelectedObject(axis.x, axis.y);
			}
		}
		...
		/// </summary>
		protected bool SendMoveEventToSelectedObject(float joyX = 0, float joyY = 0)
		{
			...
			if (joyX != 0 || joyY != 0)
				axisEventData = GetAxisEventData(joyX, joyY, 0.6f);
