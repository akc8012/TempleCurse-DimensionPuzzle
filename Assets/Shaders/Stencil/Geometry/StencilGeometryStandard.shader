Shader "Stencils/StencilGeometryStandard"
{
	Properties
	{
	...
	SubShader
	{
		...
		/////////////// everything below this line is standard stuff, which can be replaced ///////////////
	...
	FallBack "VertexLit"
	//CustomEditor "StandardShaderGUI"				// REMOVING THIS IS VERY IMPORTANT, OTHERWISE, STENCIL PROPERTY DOESN'T SHOW UP
}
